...
from tghbot.helper.themes import wzml_minimal

AVL_THEMES = {}
for theme in listdir('tghbot/helper/themes'):
    if theme.startswith('wzml_') and theme.endswith('.py'):
        AVL_THEMES[theme[5:-3]] = import_module(f'tghbot.helper.themes.{theme[:-3]}')
